...
public class Single_Buyer {
   ...
   // driver.findElement(By.xpath("//*[@id=\"seller_email\"]")).sendKeys("rakeshuppula3@gmail.com");
    ...
    driver.findElement(By.xpath("//*[@id=\"seller_email\"]")).sendKeys("rakeshuppula3@gmail.com");
    driver.findElement(By.id("domain_name")).sendKeys("UAtbbuyerbal.com");
    driver.findElement(By.id("currency")).sendKeys("USD");
    driver.findElement(By.id("agreed_amount")).sendKeys("57");
    driver.findElement(By.xpath("//*[@id=\"partner_fees\"]")).sendKeys("10%");
//    /html/body/div[1]/div[1]/div[1]/div/div[2]/div[5]/div[5]/button
    Thread.sleep(3000);
    driver.findElement(By.xpath("/html/body/div[1]/div[1]/div[1]/div/div[2]/div[5]/div[4]/div/div[2]/div/label[1]/span")).click(); 
