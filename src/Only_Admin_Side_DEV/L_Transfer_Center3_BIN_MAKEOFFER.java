...
public class L_Transfer_Center3_BIN_MAKEOFFER {
	...
	public static void main(String[] args) throws Exception {
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("/html/body/div[1]/div[4]/div[1]/div/ul/li[5]/ul/li[3]/ul/li[3]/a")).click();//BIN and MAKE OFFER
		Thread.sleep(3000);
