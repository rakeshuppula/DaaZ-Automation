...
public class Excel_to_add_Domains {
...
//		System.out.println("Before updating mk Data " + sheet.getRow(5).getCell(1));
       //  Write Date to Excel File
		...
		cell.setCellValue("PUBLICPVT.ABC");
		XSSFCell call = sheet.getRow(3).getCell(0);
		call.setCellValue("PUBLICLTD.co.IN");
		XSSFCell car = sheet.getRow(4).getCell(0);
		car.setCellValue("PUBLICTTD.COFFEE");
		XSSFCell kk = sheet.getRow(5).getCell(0);
		kk.setCellValue("PUBLICORG.in");
...
//		fileOut.close();
	    ...
	    driver.navigate().to("http://daaz_uat_user:Daaz_uat_user@2020@daaz.xyz/add/domain");
