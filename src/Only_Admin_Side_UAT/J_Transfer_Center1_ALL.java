...
public class J_Transfer_Center1_ALL {
	...
	public static void main(String[] args) throws Exception {
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath("/html/body/div[1]/div[4]/div[2]/div/div[2]/div/div/div[2]/div/div/div[2]/div/ul/li[3]/a")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("/html/body/div[1]/div[4]/div[2]/div/div[2]/div/div/div[2]/div/div/div[2]/div/ul/li[7]/a")).click();
		
		//
//		driver.findElement(By.xpath("/html/body/div[1]/div[4]/div[2]/div/div[2]/div/div/div[2]/div/div/div[3]/table/thead/tr[2]/td[3]/input")).sendKeys("Rakeshuppula3+buyer@gmail.com");
		Thread.sleep(2000);
//		driver.findElement(By.xpath("/html/body/div[1]/div[4]/div[2]/div/div[2]/div/div/div[2]/div/div/div[3]/table/thead/tr[2]/td[4]/input")).sendKeys("Rakeshuppula3@gmail.com");
//		Thread.sleep(2000);
//		driver.findElement(By.xpath("/html/body/div[1]/div[4]/div[2]/div/div[2]/div/div/div[2]/div/div/div[3]/table/thead/tr[2]/td[7]/select/option[2]")).click();
//		Thread.sleep(2000);
		//
		driver.findElement(By.xpath("/html/body/div[1]/div[4]/div[2]/div/div[2]/div/div/div[2]/div/div/div[3]/table/tbody/tr[1]/td[2]/a[1]")).click();//Domain name
		Thread.sleep(3000);
		ArrayList<String> yt=new ArrayList<String>(driver.getWindowHandles());
		driver.switchTo().window(yt.get(0));
		
		Thread.sleep(3000);
		driver.findElement(By.xpath("/html/body/div[1]/div[4]/div[2]/div/div[2]/div/div/div[2]/div/div/div[3]/table/tbody/tr[1]/td[3]/a")).click();//buyer
		Thread.sleep(2000);
		ArrayList<String> y=new ArrayList<String>(driver.getWindowHandles());
		driver.switchTo().window(y.get(0));
		
		Thread.sleep(2000);
		driver.findElement(By.xpath("/html/body/div[1]/div[4]/div[2]/div/div[2]/div/div/div[2]/div/div/div[3]/table/tbody/tr[1]/td[4]/a")).click();// Seller
		Thread.sleep(2000);
		ArrayList<String> yr=new ArrayList<String>(driver.getWindowHandles());
		driver.switchTo().window(yr.get(0));		
		Thread.sleep(2000);
		
		driver.findElement(By.xpath("/html/body/div[1]/div[4]/div[2]/div/div[2]/div/div/div[2]/div/div/div[3]/table/thead/tr[2]/td[3]/input")).sendKeys("rakesh_buyer");
		Thread.sleep(2000);
		driver.findElement(By.xpath("/html/body/div[1]/div[4]/div[2]/div/div[2]/div/div/div[2]/div/div/div[3]/table/thead/tr[2]/td[7]/select/option[2]")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("/html/body/div[1]/div[4]/div[2]/div/div[2]/div/div/div[2]/div/div/div[3]/table/thead/tr[2]/td[12]/div/button[1]")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("/html/body/div[1]/div[4]/div[2]/div/div[2]/div/div/div[2]/div/div/div[3]/table/thead/tr[2]/td[4]/input")).sendKeys("rakesh_sellerr");
		Thread.sleep(2000);
		driver.findElement(By.xpath("/html/body/div[1]/div[4]/div[2]/div/div[2]/div/div/div[2]/div/div/div[3]/table/thead/tr[2]/td[7]/select/option[2]")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("/html/body/div[1]/div[4]/div[2]/div/div[2]/div/div/div[2]/div/div/div[3]/table/thead/tr[2]/td[12]/div/button[1]")).click();
		...
		driver.findElement(By.xpath("/html/body/div[1]/div[4]/div[2]/div/div[2]/div/div/div[2]/div/div/div[3]/table/tbody/tr[1]/td[12]/a")).click();
		Thread.sleep(4000);	
