...
public class Multiple_Buyers {
	...
	public static void main(String[] args) throws Exception {
		...
		Thread.sleep(2000);
		driver.findElement(By.id("keyword")).sendKeys("DOCTOR.DOCTOR");
		...
		driver.findElement(By.xpath(
				"/html/body/div[1]/div[1]/div[1]/div/div[2]/div[3]/div[2]/section/div/div[2]/div[2]/div/div/div/div/div[1]/div[12]/div[1]/span/button"))
				.click();
        driver.findElement(By.xpath("/html/body/div[10]/div/div/div/div[2]/textarea")).sendKeys("Reason");
        Thread.sleep(1000);
