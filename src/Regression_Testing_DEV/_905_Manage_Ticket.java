...
public class _905_Manage_Ticket {
	  ...
	  // driver.manage().timeouts().implicitlyWait(3, TimeUnit.SECONDS);
	     ...
	     Thread.sleep(1000);
	     driver.findElement(By.xpath("/html/body/div[1]/div/div/div/div[2]/div[3]/div[3]/div[1]/div/div[3]/div[2]")).sendKeys("TTTTTTTT");
	     Thread.sleep(1000);
	     driver.findElement(By.id("save")).click();
	     Thread.sleep(5000);
	     ...
	     WebElement fileInput =driver.findElement(By.id("attachment_file"));
	        fileInput.sendKeys("C:\\Users\\Administrator\\Downloads\\DaaZApplicationForm (2).pdf");
