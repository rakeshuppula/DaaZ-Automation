...
public class Single_Seller {
	...
	public static void main(String[] args) throws Exception {
      ...
      driver.findElement(By.id("email")).sendKeys("uppula.rakesh@esmart.in");        
      driver.findElement(By.id("domain_name")).sendKeys("Happyinv.com");
      driver.findElement(By.id("currency")).sendKeys("GBP");
      driver.findElement(By.id("agreed_amount")).sendKeys("100");
      Thread.sleep(2000);
      driver.findElement(By.xpath("/html/body/div[1]/div[1]/div[1]/div/div[2]/div[5]/div[3]/div/div/div/label[2]/span")).click(); 
